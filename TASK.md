...
- [x] **1. Migration: adicionar `published_at` ao `workflows.db`**
...
- [x] **2. Atualizar tipos compartilhados (server)**
...
- [x] **3. Refatorar `POST /workflows/:id/publish`**
...
- [x] **6. Webhook Dual-Mode + Slug Resolution**
...
- [x] **7. Adicionar tipos no client-vue**
...
- [x] **8. Atualizar `TriggerEditor.vue` — seção Webhook**
...
- [x] **9. Criar `WorkflowPublishButton.vue`**
...
- [x] **10. Integrar `WorkflowPublishButton` na toolbar do editor**
  - Exibir ao lado do botão de Save na `Nod8WorkflowCanvas.vue` ou toolbar do editor.

- [x] **11. Badge de status na listagem de workflows**
...
- [x] **12. Criar `ProductionMonitorPanel.vue`**
...
- [x] **13. Integrar painel na sidebar**
