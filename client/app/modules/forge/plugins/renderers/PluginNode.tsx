    ...
    <>
      <div className="relative group">
        ...
        <button
          ...
          title={data.label}
          className="relative w-11 h-11 bg-card border border-border/40 rounded-lg flex items-center justify-center p-2 hover:border-border hover:bg-accent transition-colors"
        >
          <img
            src={data.icon}
            alt={data.label}
