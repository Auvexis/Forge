  ...
  return (
    <div className="flex flex-col gap-6">
      ...
      <div className="flex flex-col gap-2">
        ...
        <div className="flex items-center gap-2 p-2 text-mini bg-cyan-500/5 border border-cyan-500/10 rounded-lg text-cyan-500">
          <span className="font-bold">
            Template pointing to an array, e.g.{" "}
            <code className="text-micro">{"{{ steps.fetch.output.items }}"}</code>
          </span>
        </div>
        <Input
      ...
      <div className="flex flex-col gap-2 p-3 rounded-xl bg-accent/5 border border-border/50">
        ...
        <div className="flex flex-col gap-1 mt-1">
          <code className="text-mini font-mono text-cyan-500">$item — current item</code>
          <code className="text-mini font-mono text-cyan-500">$index — current index</code>
          <code className="text-mini font-mono text-cyan-500">$total — collection length</code>
        </div>
