...
export interface PrepareSailorDataDirectoryOptions {
  dataDir: string;
  legacyDataDir?: string;
}

export type PrepareSailorDataDirectoryResult =
...
export function prepareSailorDataDirectory(
  options: PrepareSailorDataDirectoryOptions,
): PrepareSailorDataDirectoryResult {
