...
- [x] **4.4** — ✅ **TESTE & COMMIT**: Usar cada plugin em um workflow simples. Verificar output no painel de saída do inspetor. Commitar.
...
- [x] **5.2** — ✅ **TESTE & COMMIT**: Workflow com sleep de 2s entre dois steps. Verificar no log de execução que o delay é real. Commitar.
...
- [x] **6.3** — ✅ **TESTE & COMMIT**: Escrever um JSON em arquivo, ler de volta, tentar path `../../etc/passwd` e verificar que retorna erro. Commitar.
