...
- [ ] 7. Install and add Monaco Editor with a custom Nod8 theme for code authoring.
- [ ] 8. Support manifest parameter input type `code` with Monaco Editor instead of a plain input/textarea.
