...
- [ ] CLI em JavaScript ESM.
- [ ] Usar `@clack/prompts` para `intro`, `outro`, `select`, `text`, `confirm`, `cancel`, `isCancel`.
- [ ] Usar `picocolors` para mensagens.
- [ ] Nunca criar arquivos fora do diretório onde o usuario rodou a CLI.
- [ ] Validar nome do plugin em kebab-case.
- [ ] Não sobrescrever pasta existente sem confirmacao clara.
- [ ] Plugin gerado deve usar `@auvexis/sailor-sdk@latest`.
- [ ] Final do `create` deve mostrar docs: `https://sailor.auvexis.com/api/docs`.

## Tasks

- [ ] Task 1: configurar package CLI publish-ready.
...
- [ ] Task 5: criar dominio do plugin scaffold.
