...
export interface PrepareFabricDataDirectoryOptions {
  dataDir: string;
  legacyDataDir?: string;
}

export type PrepareFabricDataDirectoryResult =
...
export function prepareFabricDataDirectory(
  options: PrepareFabricDataDirectoryOptions,
): PrepareFabricDataDirectoryResult {
