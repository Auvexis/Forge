...
export const fabricCoreUtilityNodePack = defineUtilityNodePack({
  ...
  nodes: {
    ...
    "ai-model": {
      ...
      style: { icon: "brain", iconColor: "#8b5cf6", bgColor: "#f5f3ff", borderColor: "#c4b5fd" },
    },
    "ai-memory": {
      type: "ai-memory",
      label: "AI Memory",
      ...
      presentation: { base: "standard", rounded: "full" },
      handles: [{ id: "source", label: "", type: "source", position: "top", style: "diamond" }],
      style: { icon: "database", iconColor: "#06b6d4", bgColor: "#ecfeff", borderColor: "#67e8f9" },
    },
    "ai-tool": {
      type: "ai-tool",
      label: "AI Tool",
      ...
      presentation: { base: "standard", rounded: "full" },
      handles: [{ id: "source", label: "", type: "source", position: "top", style: "diamond" }],
      style: { icon: "wrench", iconColor: "#64748b", bgColor: "#f8fafc", borderColor: "#cbd5e1" },
    },
    "text-dataset": {
      type: "text-dataset",
      label: "Text Dataset",
