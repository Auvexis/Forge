...
describe("plugin registry", () => {
  ...
  it("inserts source and paths for new plugins", () => {
    ...
    syncPluginRegistry(db, {
      ...
      version: "2.0.0",
      source: "external",
      installPath: "C:/fabric/global/plugins/external-plugin",
      manifestPath: "C:/fabric/global/plugins/external-plugin/manifest.json",
    });
    ...
    assert.equal(row.install_path, "C:/fabric/global/plugins/external-plugin");
    assert.equal(row.manifest_path, "C:/fabric/global/plugins/external-plugin/manifest.json");
  ...
  it("stores external install ids separately from original manifest plugin ids", () => {
    ...
    syncPluginRegistry(db, {
      ...
      version: "1.0.0",
      source: "external",
      installPath: "C:/fabric/global/plugins/github-tools-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa",
      manifestPath: "C:/fabric/global/plugins/github-tools-aaaaaaaaaaaaaaaaaaaaaaaaaaaaaaaa/manifest.json",
    });
    syncPluginRegistry(db, {
      ...
      version: "1.0.0",
      source: "external",
      installPath: "C:/fabric/global/plugins/github-tools-bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb",
      manifestPath: "C:/fabric/global/plugins/github-tools-bbbbbbbbbbbbbbbbbbbbbbbbbbbbbbbb/manifest.json",
    });
