...
import workflowNodeCatalogRoutes from "./routes/workflow-node-catalog.routes.ts";
...
import agentSessionRoutes from "./routes/agent-session.routes.ts";
...
fastify.register(workflowNodeCatalogRoutes);
...
fastify.register(agentSessionRoutes);
