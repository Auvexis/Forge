...
export default definePluginManifest({
  "metadata": {
    ...
    "description": "List calendars, manage events, and query free/busy availability.",
  ...
  "methods": {
    "listCalendars": {
      ...
      "agentTool": {
        ...
        "description": "Allow an AI Agent to run Lists calendars. when explicitly enabled.",
        "sideEffect": "read",
    ...
    "listEvents": {
      ...
      "agentTool": {
        ...
        "description": "Allow an AI Agent to run Lists events. when explicitly enabled.",
        "sideEffect": "read",
        "requiresApproval": false,
        "timeoutMs": 30000
      }
    ...
    "getEvent": {
      ...
      "agentTool": {
        ...
        "description": "Allow an AI Agent to run Gets an event. when explicitly enabled.",
        "sideEffect": "read",
        "requiresApproval": false,
        "timeoutMs": 30000
      }
    ...
    "createEvent": {
      ...
      "agentTool": {
        ...
        "description": "Allow an AI Agent to run Creates an event. when explicitly enabled.",
        "sideEffect": "write",
    ...
    "updateEvent": {
      ...
      "agentTool": {
        ...
        "description": "Allow an AI Agent to run Updates an event. when explicitly enabled.",
        "sideEffect": "write",
        "requiresApproval": true,
        "timeoutMs": 30000
      }
    ...
    "deleteEvent": {
      "metadata": {
        "label": "Delete Event",
        "description": "Deletes an event with confirmation."
      },
      "parameters": {
        "type": "object",
        "properties": {
    ...
    "freeBusy": {
      "metadata": {
        "label": "Free Busy",
        "description": "Queries availability."
      },
      "parameters": {
        "type": "object",
        "properties": {
    ...
    "quickAddEvent": {
      "metadata": {
        ...
        "description": "Creates an event from natural language."
      },
      "parameters": {
        "type": "object",
        "properties": {
    ...
    "onEventStartingSoon": {
      ...
      "parameters": {
        ...
        "properties": {
          ...
          "minutesBefore": {
            "type": "integer",
            "description": "Minutes before start time.",
            "default": 10,
            "minimum": 1,
            "x-label": "Minutes Before",
            "x-input-type": "number"
          },
          "resourceId": {
            "type": "string",
