  ...
  "metadata": {
    ...
    "agentCapabilities": {
      "memoryStore": {
        ...
        "description": "Stores and retrieves Agent memory records in a PostgreSQL database.",
  ...
  "methods": {
    ...
    "searchAgentMemory": {
      "metadata": {
        ...
        "description": "Searches Agent memory records stored by Fabric in PostgreSQL."
      },
      "parameters": {
        "type": "object",
        "properties": {
    ...
    "putAgentMemory": {
      "metadata": {
        "label": "Put Agent Memory",
        "description": "Stores or updates an Agent memory record in PostgreSQL."
      },
      "parameters": {
        "type": "object",
        "properties": {
    ...
    "listSchemas": {
      "metadata": {
        "label": "List Schemas",
        "description": "Lists non-system PostgreSQL schemas."
      },
      "parameters": {
        "type": "object",
        "properties": {},
    ...
    "listTables": {
      "metadata": {
        "label": "List Tables",
        "description": "Lists tables and views in a schema."
      },
      "parameters": {
        "type": "object",
        "properties": {
    ...
    "describeTable": {
      "metadata": {
        ...
        "description": "Returns columns, types, nullability, defaults, and primary key flags."
      },
      "parameters": {
        "type": "object",
        "properties": {
    ...
    "selectRows": {
      "metadata": {
        "label": "Select Rows",
        "description": "Runs a safe SELECT with optional columns, filters, ordering, limit, and offset."
      },
      "parameters": {
        "type": "object",
        "properties": {
    ...
    "insertRow": {
      "metadata": {
        "label": "Insert Row",
        "description": "Inserts one JSON row with parameterized values."
      },
      "parameters": {
        "type": "object",
        "properties": {
    ...
    "updateRows": {
      "metadata": {
        "label": "Update Rows",
        "description": "Updates rows using a simple equality filter and returns changed rows."
      },
      "parameters": {
        "type": "object",
        "properties": {
    ...
    "deleteRows": {
      "metadata": {
        "label": "Delete Rows",
        "description": "Deletes rows and requires confirm: true."
      },
      "parameters": {
        "type": "object",
        "properties": {
    ...
    "executeQuery": {
      "metadata": {
        "label": "Execute Query",
        "description": "Runs raw SQL only when unsafe SQL is enabled in credentials."
      },
      "parameters": {
        "type": "object",
        "properties": {
    ...
    "transaction": {
      "metadata": {
        "label": "Transaction",
        "description": "Runs raw SQL statements in a transaction only when unsafe SQL is enabled."
      },
      "parameters": {
        "type": "object",
        "properties": {
          "statements": {
            "type": "array",
            "description": "SQL statements with optional values.",
            "items": {
              "type": "object",
              "properties": {
                "sql": {
  ...
  "triggers": {
    "onRowInserted": {
      "metadata": {
        ...
        "description": "Triggers when a PostgreSQL row is inserted."
      },
      "delivery": {
        "mode": "polling",
    ...
    "onRowUpdated": {
      "metadata": {
        ...
        "description": "Triggers when a PostgreSQL row is updated."
      },
      "delivery": {
        "mode": "polling",
        "recommendedPollSeconds": 60
    ...
    "onQueryMatch": {
      "metadata": {
        "label": "On Query Match",
        "description": "Triggers when a safe read query returns rows."
      },
      "delivery": {
        "mode": "polling",
        "recommendedPollSeconds": 60
      ...
      "parameters": {
        ...
        "properties": {
          ...
          "primaryKey": {
            "type": "string",
            "description": "Primary key column used to dedupe and track rows.",
            "x-label": "Primary Key",
            "x-input-type": "text"
          },
          "eventAction": {
