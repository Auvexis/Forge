...
test('workflow editor status bar exposes chat state and central workflow bottom panel', () => {
  ...
  assert.doesNotMatch(source, />\s*Tree\s*</)
  ...
  assert.doesNotMatch(source, /toggleBottomPanel\('tree'\)/)
