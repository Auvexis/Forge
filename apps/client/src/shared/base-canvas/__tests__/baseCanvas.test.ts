...
describe('BaseCanvas component contract', () => {
  ...
  it('renders alignment guide overlays during item movement', () => {
    ...
    assert.match(source, /activeAlignmentGuides/)
    assert.match(source, /background: var\(--fabric-base-canvas-alignment-guide-bg, #3b82f6\);/)
    assert.match(source, /--fabric-base-canvas-alignment-guide-shadow/)
  })
  ...
  it('supports visual marquee, background pattern, and passive rulers', () => {
    ...
    assert.match(source, /backgroundColor: 'var\(--fabric-base-canvas-bg, #0b0b0d\)'/)
    assert.match(source, /patternColor: 'var\(--fabric-base-canvas-grid, rgba\(255, 255, 255, 0\.08\)\)'/)
    assert.match(source, /marqueeBg: 'var\(--fabric-base-canvas-selection-bg, rgba\(59, 130, 246, 0\.12\)\)'/)
    assert.match(source, /marqueeBorderColor: 'var\(--fabric-base-canvas-selection-border, rgba\(96, 165, 250, 0\.85\)\)'/)
    ...
    assert.match(ruler, /rulersBg: 'var\(--fabric-base-canvas-ruler-bg, var\(--fabric-bg-canvas\)\)'/)
    assert.match(ruler, /rulersText: 'var\(--fabric-base-canvas-ruler-text, rgba\(255, 255, 255, 0\.54\)\)'/)
    assert.match(ruler, /rulersLines: 'var\(--fabric-base-canvas-ruler-lines, rgba\(255, 255, 255, 0\.2\)\)'/)
