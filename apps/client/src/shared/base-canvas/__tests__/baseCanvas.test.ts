...
describe('BaseCanvas component contract', () => {
  ...
  it('renders alignment guide overlays during item movement', () => {
    ...
    assert.match(source, /activeAlignmentGuides/)
    assert.match(source, /background: var\(--fabric-base-canvas-alignment-guide-bg\);/)
  ...
  it('supports visual marquee, background pattern, and passive rulers', () => {
    ...
    assert.match(source, /backgroundColor: 'var\(--fabric-base-canvas-bg\)'/)
    assert.match(source, /patternColor: 'var\(--fabric-base-canvas-grid\)'/)
    assert.match(source, /marqueeBg: 'var\(--fabric-base-canvas-selection-bg\)'/)
    assert.match(source, /marqueeBorderColor: 'var\(--fabric-base-canvas-selection-border\)'/)
    ...
    assert.match(ruler, /rulersBg: 'var\(--fabric-base-canvas-ruler-bg\)'/)
    assert.match(ruler, /rulersText: 'var\(--fabric-base-canvas-ruler-text\)'/)
    assert.match(ruler, /rulersLines: 'var\(--fabric-base-canvas-ruler-lines\)'/)
