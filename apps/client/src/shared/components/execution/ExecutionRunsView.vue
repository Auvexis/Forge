...
.execution-runs-view__copy { display: grid; min-width: 0; gap: 1px; }
.execution-runs-view__copy strong { color: var(--fabric-execution-runs-text); font-size: var(--fabric-text-xs); }
.execution-runs-view__copy small, .execution-runs-view__run code, .execution-runs-view__state { color: var(--fabric-execution-runs-muted-text); font-size: 10px; line-height: 1.15; }
