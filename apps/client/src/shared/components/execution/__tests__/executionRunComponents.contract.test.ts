...
describe('shared execution run components', () => {
  ...
  it('renders a collapsible tree with complete branch connectors and clean node icons', () => {
    ...
    assert.match(source, /border-left: 1px solid var\(--fabric-execution-node-tree-border-strong\)/)
    assert.match(source, /border-top: 1px solid var\(--fabric-execution-node-tree-border-strong\)/)
    ...
    assert.match(source, /\.execution-node-tree__row \{[^}]*border: 1px solid var\(--fabric-execution-node-tree-border-muted\)/)
    assert.match(source, /\.execution-node-tree__row \{[^}]*border-radius: var\(--fabric-execution-node-tree-row-radius\)/)
  ...
  it('shows the selected real icon and guarded text payload details', () => {
    ...
    assert.match(source, /\.execution-node-inspector__section \{[^}]*border: 1px solid var\(--fabric-execution-node-inspector-border-muted\)/)
    assert.match(source, /\.execution-node-inspector__section \{[^}]*border-radius: var\(--fabric-execution-node-inspector-section-radius\)/)
    assert.match(source, /\.execution-node-inspector__section :deep\(\.base-code-editor\) \{[^}]*border-radius: var\(--fabric-execution-node-inspector-code-editor-radius\)/)
