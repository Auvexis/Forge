  ...
  <button
    ...
    :class="[
      tone ? `base-rail-item--${tone}` : null,
      {
        ...
        'base-rail-item--toggle-on': toggle === 'on',
        'base-rail-item--toggle-off': toggle === 'off',
      },
    ]"
    type="button"
    :title="title"
...
.base-rail-item--toggle-on {
  color: var(--fabric-workbench-rail-button-toggle-text, var(--fabric-accent));
}

.base-rail-item--toggle-on::after,
.base-rail-item--toggle-off::after {
  position: absolute;
  right: 5px;
  bottom: 5px;
  width: 10px;
...
.base-rail-item--toggle-on::before {
  position: absolute;
  right: 6px;
  bottom: 6px;
  width: 3px;
