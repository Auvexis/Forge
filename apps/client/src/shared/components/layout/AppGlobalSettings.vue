  ...
  >
    ...
    <div class="gs-shell">
      ...
      <aside class="gs-aside">
        <nav class="gs-nav" style="position: relative">
          <BaseButton
            v-for="tab in tabs"
            :key="tab.id"
            variant="ghost"
      ...
      <main class="gs-main">
        ...
        <section class="gs-scroll-area gs-section">
          ...
          <transition name="fade" mode="out-in">
            ...
            >
              ...
              >
                ...
                <p class="gs-section__desc">
                  Use <code class="gs-code" v-pre>{{ env.KEY }}</code> in any
                  workflow to reference these values.
                </p>
              </div>
            </div>
            <div
            ...
            >
              ...
              >
                ...
                <p class="gs-section__desc">
                  System preferences for this Fabric instance.
                </p>
              </div>
            </div>
            <div
            ...
            >
              ...
              >
                ...
                <p class="gs-section__desc">
                  Desktop behavior and update preferences.
                </p>
              </div>
            </div>
            <div
              v-else-if="activeTab === 'auvexis'"
              key="head-auvexis"
              class="gs-section__head"
            >
              <div
              ...
              >
                ...
                <p class="gs-section__desc">
                  Connect this Fabric profile to Auvexis Accounts.
                </p>
              </div>
            </div>
          </transition>
          ...
          <transition name="slide-up" mode="out-in">
            ...
            >
              <section
                class="gs-vars__composer"
                aria-label="Create environment variable"
              >
                <div class="gs-vars__composer-head">
                  <div>
                    <strong>Add Variable</strong>
                    <span
                      >Create values available as
                      <code class="gs-code" v-pre>{{ env.KEY }}</code></span
                    >
                  </div>
                </div>
                  ...
                  <label class="gs-vars__field">
                    ...
                    <div class="gs-vars__secret-field">
                      ...
                      >
                        <template #left>
                          <LucideIcon
                            :name="showNewVarValue ? 'eye-off' : 'eye'"
                            :size="15"
                          />
                        </template>
                      </BaseButton>
              ...
              <div
                v-else-if="store.variables.length === 0"
                class="gs-state gs-vars__empty"
              >
                ...
                >
                  ...
                  <div class="gs-vars__actions">
                    <code
                      ...
                      :title="
                        revealedVars[v.key] ? v.value : 'Click eye to reveal'
                      "
                    >
                    ...
                    >
                      <template #left>
                        <LucideIcon
                          :name="revealedVars[v.key] ? 'eye-off' : 'eye'"
                          :size="13"
                        />
                      </template>
                    </BaseButton>
            ...
            >
              ...
              <!-- Empty -->
              <div
                v-else-if="authPlugins.length === 0"
                class="gs-state"
                style="padding: 2rem"
              >
                <LucideIcon name="key-round" :size="24" />
                ...
                <div
                  ...
                  :class="{
                    'gs-cred-grid-item--active':
                      selectedPluginForMenu?.id === plugin.id,
                  }"
                ...
                >
                  <img
                    ...
                    style="
                      ...
                      object-fit: contain;
                      border-radius: var(
                        --fabric-global-settings-preview-radius
                      );
                  ...
                  >
                    <LucideIcon
                      :name="
                        plugin.status === 'connected' ? 'check' : 'circle-alert'
                      "
                      :size="12"
                    />
                    {{
              ...
              <BaseMiniMenu
                ...
                :title="
                  'Configure ' +
                  (selectedPluginForMenu?.manifest?.metadata?.name ??
                    selectedPluginForMenu?.id)
                "
              ...
              >
                ...
                >
                  ...
                  <div
                    v-if="
                      selectedPluginForMenu.auth_type === 'oauth2' &&
                      pluginStatus?.oauth_redirect_uri
                    "
                    style="
                      display: flex;
                      flex-direction: column;
                      ...
                      background: var(--fabric-app-global-settings-bg-surface);
                      border-radius: var(
                        --fabric-global-settings-inline-card-radius
                      );
                      border: 1px solid var(--fabric-app-global-settings-border);
                  ...
                  >
                    ...
                    <p
                      ...
                      style="
                        ...
                        color: var(--fabric-app-global-settings-text-muted);
                  ...
                  <template
                    v-for="(schema, fieldKey) in credentialSchema(
                      selectedPluginForMenu,
                    )"
                    :key="fieldKey"
                  >
                    <div
                      ...
                      >
                        <BaseInput
                          ...
                          :type="
                            ...
                            !showCredValues[
                              `${selectedPluginForMenu.id}_${fieldKey}`
                            ]
                              ? 'password'
                              : 'text'
                          "
                ...
                <template #footer>
                  ...
                  >
                    ...
                    <BaseButton
                      variant="primary"
                      :disabled="
                        !hasPendingCredFields(selectedPluginForMenu?.id)
                      "
                      :loading="isSavingCred === selectedPluginForMenu?.id"
                      @click="
                        handleSaveCredentialAndClose(selectedPluginForMenu.id)
                      "
                      style="
                        width: 100%;
                        justify-content: center;
                    ...
                    <BaseButton
                      ...
                      variant="secondary"
                      :title="
                        pluginStatus?.oauth_ui?.buttonText ||
                    ...
                    >
                      <template #left>
                        <img
                          v-if="
                            pluginStatus?.oauth_ui?.buttonIcon?.startsWith(
                              'http',
                            )
                          "
                          :src="pluginStatus.oauth_ui.buttonIcon"
                          style="width: 16px; height: 16px; object-fit: contain"
                        />
                        <LucideIcon
                          v-else-if="pluginStatus?.oauth_ui?.buttonIcon"
                          :name="pluginStatus.oauth_ui.buttonIcon"
                          :size="16"
                        />
                    ...
                    >
                      Waiting for authorization. Return here after finishing in
                      the new tab.
                    </p>
                    <BaseButton
                      v-if="
                    ...
                    <BaseButton
                      v-else-if="
                        selectedPluginForMenu?.auth_type !== 'none' &&
                        selectedPluginForMenu?.auth_type !== 'oauth2'
                      "
                      variant="secondary"
                    ...
                    <BaseButton
                      v-if="
                        hasCredential(selectedPluginForMenu?.id) &&
                      ...
                      @click="
                        handleDeleteCredentialAndClose(selectedPluginForMenu.id)
                      "
                    >
                      <template #left
                ...
                <div class="gs-pref-row__label">
                  ...
                  <div>
                    ...
                    <span class="gs-pref-row__hint"
                      >How long to keep execution logs</span
                    >
                  </div>
                </div>
                <BaseSelect
              ...
              <div v-if="isDesktopWindow" class="gs-pref-row">
                <div class="gs-pref-row__label">
                  ...
                  <div>
                    ...
                    <span class="gs-pref-row__hint"
                      >Adjust the desktop interface scale</span
                    >
                  </div>
                </div>
              ...
              <div class="gs-pref-row">
                <div class="gs-pref-row__label">
                  ...
                  <div>
                    ...
                    <span class="gs-pref-row__hint"
                      >Base URL used by production webhooks and forms</span
                    >
                  </div>
                </div>
                <div
            ...
            >
              <div class="gs-pref-row">
                <div class="gs-pref-row__label">
                  ...
                  <div>
                    ...
                    <span class="gs-pref-row__hint"
                      >Send native notifications when Fabric is not
                      focused</span
                    >
                  </div>
                </div>
              ...
              <div class="gs-pref-row">
                <div class="gs-pref-row__label">
                  ...
                  <div>
                    ...
                    <span class="gs-pref-row__hint"
                      >Hide Fabric in the system tray when minimized</span
                    >
                  </div>
                </div>
                <BaseSwitch
              ...
              <div class="gs-pref-row">
                <div class="gs-pref-row__label">
                  ...
                  <div>
                    ...
                    <span class="gs-pref-row__hint"
                      >Keep Fabric running in the tray when the window
                      closes</span
                    >
                  </div>
                </div>
              ...
              <div class="gs-pref-row">
                <div class="gs-pref-row__label">
                  ...
                  <div>
                    ...
                    <span class="gs-pref-row__hint"
                      >Start Fabric automatically when you sign in</span
                    >
                  </div>
                </div>
                <BaseSwitch
                ...
                <div class="gs-pref-row__label">
                  ...
                  <div>
                    ...
                    <span class="gs-pref-row__hint">
                      {{
                        updateCheckMessage ||
                        "Look for safe Fabric Desktop updates when the app opens"
                      }}
                    </span>
                  </div>
                </div>
              ...
              <div class="gs-pref-row">
                <div class="gs-pref-row__label">
                  ...
                  <div>
                    <span class="gs-pref-row__name"
                      >Install Updates Automatically</span
                    >
                    <span class="gs-pref-row__hint"
                      >Prepare safe desktop updates for automatic install after
                      signed installers are enabled</span
                    >
                  </div>
                </div>
                <BaseSwitch
...
const windowZoomLabel = computed(
  () => `${Math.round(windowZoomFactor.value * 100)}%`,
);
const desktopNotificationsEnabled = computed(
  () => store.settings.desktop_notifications_enabled !== false,
);
const desktopMinimizeToTray = computed(
  () => store.settings.desktop_minimize_to_tray !== false,
);
const desktopCloseToTray = computed(
  () => store.settings.desktop_close_to_tray !== false,
);
const desktopOpenAtLogin = computed(
  () => store.settings.desktop_open_at_login === true,
);
const updatesAutoCheck = computed(
  () => store.settings.updates_auto_check !== false,
);
const updatesAutoInstall = computed(
  () => store.settings.updates_auto_install === true,
);
...
const activeTabTitle = computed(
  () => tabs.find((tab) => tab.id === activeTab.value)?.label ?? "Settings",
);
...
const selectedPluginIcon = computed(() =>
  selectedPluginForMenu.value
    ? pluginIcon(selectedPluginForMenu.value)
    : "puzzle",
);
...
async function loadPlugins() {
  ...
  try {
    ...
    if (store.targetPluginId) {
      const target = plugins.value.find(
        (p: any) => p.id === store.targetPluginId,
      );
...
function setCredField(
  pluginId: string,
  fieldKey: string,
  value: string | number,
) {
  if (!pendingCredFields.value[pluginId])
    pendingCredFields.value[pluginId] = {};
...
async function handleTestConnection(pluginId: string) {
  try {
    ...
    toast.success(
      ...
      "The plugin credentials are valid and responding.",
    );
  } catch (e: any) {
    toast.error(
      "Connection test failed",
      e.message || "Could not verify credentials.",
    );
  }
}
...
const logRetentionValue = computed(() =>
  String(store.settings.log_retention_days ?? "30"),
);
const publicUrlLocked = computed(
  () => store.settings.public_url_locked === true,
);
...
const restartConfirmRef = ref<InstanceType<
  typeof BaseRestartApplicationConfirm
> | null>(null);
...
async function checkForDesktopUpdates(options: { manual?: boolean } = {}) {
  ...
  try {
    ...
    if (update.updateAvailable) {
      ...
      if (updatesAutoInstall.value) {
        toast.info(
          ...
          "Automatic install will be enabled after signed installers are available.",
        );
      }
      return;
    }
    ...
    if (options.manual) {
      toast.success(
        "Fabric is up to date",
        "No newer safe desktop release was found.",
      );
    }
  } catch (err: any) {
    ...
    if (options.manual) {
      toast.error(
        "Update check failed",
        err?.message ?? "Could not reach GitHub releases.",
      );
    }
  } finally {
...
async function setWindowZoom(zoomFactor: number) {
  const nextZoomFactor = await window.fabricDesktop?.setZoomFactor(
    Number(zoomFactor.toFixed(2)),
  );
...
async function handlePublicUrlSave() {
  ...
  try {
    const result = await store.saveSetting<PublicUrlSaveResult>(
      "public_url",
      publicUrlDraft.value.trim(),
    );
    ...
    toast.error(
      "Public URL not saved",
      err?.message ?? "Could not save the public URL.",
    );
  } finally {
...
async function handlePublicUrlClear() {
  ...
  try {
    ...
    toast.error(
      "Public URL not cleared",
      err?.message ?? "Could not clear the public URL.",
    );
  } finally {
