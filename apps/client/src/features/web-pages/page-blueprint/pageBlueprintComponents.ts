...
export const PAGE_BLUEPRINT_COMPONENT_REPEAT_OUTPUT_FIELD_ID = 'repeat:output'
...
function componentRepeatOutputField(): PageBlueprintField {
  return {
    id: PAGE_BLUEPRINT_COMPONENT_REPEAT_OUTPUT_FIELD_ID,
    label: 'Repeat',
    type: 'array',
    direction: 'output',
    mode: 'multiple',
