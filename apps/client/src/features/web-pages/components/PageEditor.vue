  ...
  >
    ...
    >
      ...
      <BaseCanvas
          ...
          :rulers="true"
          :snap-to-grid="false"
          background-color="var(--fabric-page-editor-bg-canvas)"
          pattern-color="var(--fabric-page-editor-border)"
          pattern-style="dot"
          :pattern-size="30"
          rulers-bg="var(--fabric-page-editor-bg-canvas)"
          rulers-text="var(--fabric-page-editor-text-muted)"
          rulers-lines="var(--fabric-page-editor-border)"
    ...
    >
      <PageBlueprintInspectorPanel
        ...
        @refresh-workflows="pageActionsStore.loadAvailableActions"
      />
    </AppPanel>
