...
test('workflow bottom panel renders the selected view without internal tabs', () => {
  ...
  assert.match(source, /syncSingleParentChildren/)
  assert.match(source, /occupiedSlots/)
  assert.match(source, /pushSingleParentChildrenLane/)
  assert.match(source, /centeredLane/)
