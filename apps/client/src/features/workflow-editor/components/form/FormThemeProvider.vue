...
const presetDefaults: Partial<Record<NonNullable<FormTheme['preset']>, FormTheme>> = {
  'social-media': {
    ...
    container: {
      backgroundColor: 'var(--fabric-form-theme-provider-bg-surface)',
      borderColor: 'var(--fabric-form-theme-provider-border)',
      borderWidth: 1,
      radius: 12,
      shadow: 'lg',
      maxWidth: 560,
    ...
    button: {
      width: 'full',
      shape: 'medium',
      backgroundColor: 'var(--fabric-form-theme-provider-accent)',
      textColor: '#ffffff',
      borderColor: 'var(--fabric-form-theme-provider-accent)',
    ...
    typography: {
      ...
      baseSize: 14,
      weight: 500,
      titleColor: 'var(--fabric-form-theme-provider-text-primary)',
      subtitleColor: 'var(--fabric-form-theme-provider-text-secondary)',
    },
    fields: {
      backgroundColor: 'var(--fabric-form-theme-provider-bg-overlay)',
      textColor: 'var(--fabric-form-theme-provider-text-primary)',
      borderColor: 'var(--fabric-form-theme-provider-border)',
      focusColor: 'var(--fabric-form-theme-provider-accent)',
      radius: 8,
      shape: 'medium',
      spacing: 16,
    },
