...
const presetDefaults: Partial<Record<NonNullable<FormTheme['preset']>, FormTheme>> = {
  'social-media': {
    ...
    container: {
      backgroundColor: 'var(--fabric-bg-surface)',
      borderColor: 'var(--fabric-border)',
      borderWidth: 1,
      radius: 12,
      shadow: 'lg',
      maxWidth: 560,
    ...
    button: {
      width: 'full',
      shape: 'medium',
      backgroundColor: 'var(--fabric-accent)',
      textColor: '#ffffff',
      borderColor: 'var(--fabric-accent)',
    ...
    typography: {
      ...
      baseSize: 14,
      weight: 500,
      titleColor: 'var(--fabric-text-primary)',
      subtitleColor: 'var(--fabric-text-secondary)',
    },
    fields: {
      backgroundColor: 'var(--fabric-bg-overlay)',
      textColor: 'var(--fabric-text-primary)',
      borderColor: 'var(--fabric-border)',
      focusColor: 'var(--fabric-accent)',
      radius: 8,
      shape: 'medium',
      spacing: 16,
    },
