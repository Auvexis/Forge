...
.json-children {
  margin-left: 12px;
  padding-left: 8px;
  border-left: 1px solid var(--fabric-json-tree-view-border);
}
.json-toggle-btn {
  width: 20px;
  height: 20px;
  ...
  color: var(--fabric-json-tree-view-text-muted);
  transition: all 0.15s ease;
  user-select: none;
}
.json-toggle-btn:hover {
  color: var(--fabric-json-tree-view-button-ghost-hover-text);
  background-color: var(--fabric-json-tree-view-button-ghost-hover);
}
.json-key {
  color: var(--json-color-key, var(--fabric-json-tree-view-text-primary));
  min-width: 0;
  flex-shrink: 0;
...
.json-punctuation {
  color: var(--json-color-punctuation, var(--fabric-json-tree-view-text-muted));
}
.draggable-item {
  cursor: grab;
}
