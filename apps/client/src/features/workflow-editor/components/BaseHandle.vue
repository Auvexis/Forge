...
.fabric-base-handle__visual {
  ...
  border: 1px solid var(--fabric-workflow-handle-border);
  border-radius: 100%;
...
.fabric-base-handle:hover .fabric-base-handle__visual {
  border-color: var(--fabric-workflow-handle-hover-border, var(--fabric-workflow-handle-border));
  background-color: var(--fabric-workflow-handle-hover-bg);
}
