...
const presetDefaults: Partial<Record<NonNullable<FormTheme['preset']>, FormTheme>> = {
  'social-media': {
    ...
    container: {
      backgroundColor: 'var(--sailor-bg-surface)',
      borderColor: 'var(--sailor-border)',
      borderWidth: 1,
      radius: 12,
      shadow: 'lg',
      maxWidth: 560,
    ...
    button: {
      width: 'full',
      shape: 'medium',
      backgroundColor: 'var(--sailor-accent)',
      textColor: '#ffffff',
      borderColor: 'var(--sailor-accent)',
    ...
    typography: {
      ...
      baseSize: 14,
      weight: 500,
      titleColor: 'var(--sailor-text-primary)',
      subtitleColor: 'var(--sailor-text-secondary)',
    },
    fields: {
      backgroundColor: 'var(--sailor-bg-overlay)',
      textColor: 'var(--sailor-text-primary)',
      borderColor: 'var(--sailor-border)',
      focusColor: 'var(--sailor-accent)',
      radius: 8,
      shape: 'medium',
      spacing: 16,
    },
