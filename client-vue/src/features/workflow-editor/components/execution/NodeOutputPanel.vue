...
.nop-status-icon--idle    { background: rgba(255, 255, 255, 0.05); color: var(--nod8-text-muted); }
.nop-status-icon--running { background: rgba(245, 158,  11, 0.15); color: var(--nod8-amber-400); }
.nop-status-icon--success { background: rgba( 52, 211, 153, 0.15); color: var(--nod8-green-400); }
.nop-status-icon--failed  { background: rgba(248, 113, 113, 0.15); color: var(--nod8-red-400);   }
