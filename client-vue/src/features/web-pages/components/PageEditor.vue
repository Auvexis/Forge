    ...
    >
      ...
      <template>
        <BaseCanvas
          ...
          :rulers="true"
          :snap-to-grid="false"
          background-color="var(--web-page-canvas-bg)"
          pattern-color="var(--web-page-canvas-pattern)"
          pattern-style="dot"
          :pattern-size="18"
          rulers-bg="var(--web-page-ruler-bg)"
          rulers-text="var(--web-page-ruler-text)"
          rulers-lines="var(--web-page-ruler-line)"
